...
![Version](https://img.shields.io/badge/version-6.9.60-blue)
...
Current module baseline: v6.9.60, versionCode 142.
...
```powershell
# Prerequisites: JDK 17+, Android SDK 37 compile / targetSdk 36, AGP 9.2
